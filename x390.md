...
Interestingly, this matrix is very similar to the other one, including the wire order, but with a couple of minor differences, namely, `Home`, `Ins`, `PrtSc`, `PgUp` and `PgDn`. 
